...
#   budget: large
#   spectral.alpha = 0.005
#
# Outputs (no overwrite):
#   results/arc/llama31_8b_smart_spectral_alpha0005/erm_smart_spectral/budget_large/seed42/*
#
# Optional env:
#   VENV=/LOCAL2/zhuoyun/Robustfairnessgpu3/venv
#   HF_HOME=/LOCAL2/zhuoyun/hf_cache
#   WANDB_PROJECT=icml_wcr_spectral
#   WANDB_GROUP=llama31_arc_alpha0005
...
WANDB_GROUP="${WANDB_GROUP:-llama31_arc_alpha0005}"
...
RESULTS_ROOT="${RESULTS_ROOT:-results/arc/llama31_8b_smart_spectral_alpha0005}"
